      ...
      <div className="mx-auto grid min-h-20 w-full max-w-[1440px] items-center gap-4 px-5 py-3 sm:px-8 lg:grid-cols-[minmax(260px,1fr)_520px_minmax(220px,1fr)] lg:px-10">
        <div className="flex min-w-0 items-center gap-3">
          ...
          {institutionLogoUrl ? (
            ...
            <span
              className="grid size-10 shrink-0 place-items-center rounded-xl bg-blue-100 text-[11px] font-bold text-blue-700 ring-1 ring-blue-200/70 dark:bg-blue-950 dark:text-blue-300 dark:ring-blue-800"
